 ...
 *
 */
public final class TokenSequenceSingletonFactory implements Function<String, String[]> {
	...
	private final ConcurrentMap<String, String[]> singletonInstances;
	...
	@Override
	public String[] apply(final String tokenStr) {
		return singletonInstances.computeIfAbsent(tokenStr, key -> TOKEN_DELIMITER_PATTERN.splitAsStream(key).map(String::intern).toArray(String[]::new));
	}
